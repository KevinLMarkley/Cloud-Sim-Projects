 ...
 * topology on them.
 */
public class NetworkTopology_KevinMarkley {
	...
	public static void main(String[] args) {
		...
		try {
			...
			NetworkTopology.buildNetworkTopology("KevinMarkley_Topology.brite");
			...
			Log.printLine("NetworkTopology_KevinMarkley finished!");
		}
		catch (Exception e) {
			e.printStackTrace();
